...
function updateCart(ItemAdd) {
  axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/update-cart', ItemAdd).then(function (res) {
    console.log(res);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  addtoCart.forEach(function (button) {
    button.addEventListener('click', function () {
      var itemData = button.dataset.food;
      try {
        var ItemAdd = JSON.parse(itemData);
        updateCart(ItemAdd);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunksmart_trolley"] = self["webpackChunksmart_trolley"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/css/style"], () => (__webpack_require__("./resources/scss/app.scss")))
